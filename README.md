...
## A. Description
TwoCents is a React app built for Chad Penny by Kevin Cuison & Bryant Cabrera.
...
## F. Github workflow
1.	Link to repo: [https://github.com/BryantCabrera/twocents](https://github.com/BryantCabrera/twocents).  
2.	Log into your personal repo.  Then, click link above and fork the repo.  Make sure the repo is in your personal GitHub (go to your personal GitHub account and the project repo “mom-me” should be there).  Then, from YOUR PERSONAL FORK, clone it to your local repo.
    ...
    2.  $git remote add upstream https://github.com/BryantCabrera/twocents
